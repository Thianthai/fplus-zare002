...
| OQ-40 | assignment ของบรรทัด G/L — เราใส่ posting date ทุกบรรทัด ตัวอย่างปล่อยให้ sort key เติมเอง (001 ว่าง · 002 cost center · 003 posting date) · จะให้เหมือนเป๊ะต้องไม่ส่ง assignment เลย | ฟังก์ชันนอล | 8B | ไม่กระทบการ post ถามเพื่อความเหมือน | ⬜ |
