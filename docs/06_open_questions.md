...
| OQ-38 | **`SubmitMessage` แสดงบนจอที่ไหน** — อยู่ใน `ZC_ZARE002` แล้วแต่ยังไม่มี `@UI.lineItem` (คอลัมน์ 200 ตัวอักษรกว้างเกิน) · ทางเลือก: คอลัมน์ importance LOW · popover ที่ Fiori extension · หรือโชว์เฉพาะแถว E | ผู้ใช้ + Fiori | 8B | ⬜ | ⬜ |
