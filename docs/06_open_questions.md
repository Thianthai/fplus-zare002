...
| OQ-25 | **ทีม Fiori ยังไม่ได้เปิด inline / mass edit ที่คอลัมน์ Reject Reason ใน app BAS** — backend พร้อมแล้วทั้งหมด · brief ส่งต่ออยู่ที่ `docs/07_fiori_handover.md` | ทีม Fiori | Phase 7 | **บล็อก 7.7 ทั้งหมด** — Reject ทดสอบผ่าน UI ไม่ได้จนกว่าจะแก้ค่าได้ · ระหว่างรอทดสอบ backend ผ่าน EML ได้ (OQ-24) | ⬜ |
